...
Personal study notes from two courses I'm working through in parallel:

- 📘 **MIT 6.824 — Distributed Systems**
- 🎓 **UIUC Cloud Computing Specialization**

Notes are written in Markdown and organized by week. Each course also has a dedicated lab file with my solutions and observations.
...
**MIT 6.824 — Distributed Systems**
- MapReduce, GFS, Raft, Zookeeper
- Consensus, fault tolerance, replication
- Distributed transactions, Spanner, CRDT

**UIUC Cloud Computing Specialization**
- Cloud infrastructure and virtualization
- Resource management and scheduling
- Distributed storage and NoSQL
